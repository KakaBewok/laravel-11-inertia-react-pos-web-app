...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
    ...
    return (
        <aside
            ref={sidebar}
            className={`absolute left-0 top-0 z-9999 flex h-screen w-72 flex-col overflow-y-hidden bg-slate-900 duration-300 ease-linear lg:static lg:translate-x-0 ${
                                ...
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <Link
                                                href="#"
                                                className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-slate-300 duration-300 ease-in-out hover:bg-slate-800 dark:hover:bg-slate-800 ${
                                                    (url === "/auth" ||
                                                        url.includes("auth")) &&
                                                    "bg-slate-800"
                                                }`}
                                            ...
                                            >
                                                <ul className="flex flex-col gap-3 pl-6 mt-4 mb-5">
                                                    <li>
                                                        <Link
                                                            href="/"
