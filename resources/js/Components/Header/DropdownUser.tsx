            ...
            >
                ...
                >
                    ...
                    <span className="w-12 h-12 rounded-full">
                        <img src={UserOne} alt="User Photo" />
                    </span>
                </div>
                ...
                {dropdownOpen && (
                    <div
                        className={`absolute right-0 mt-7 flex w-60 flex-col rounded-sm border border-stroke bg-slate-50 shadow-default dark:border-strokedark dark:bg-slate-700`}
                    >
                        <ul className="flex flex-col px-6 py-4 border-b border-stroke dark:border-strokedark">
                            <li>
                                <Link
                        ...
                        <TooltipHover message="Under Maintenance!">
                            <ul className="flex flex-col px-6 py-4 border-b border-stroke dark:border-strokedark">
                                <li>
                                    <Link
                                        href="#"
                                        className="dark:text-slate-300 dark:hover:text-slate-400 flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out text-slate-900 hover:text-slate-400 lg:text-base"
                                        disabled
                                    >
                                        <svg
                                            className="fill-current"
                        ...
                        <button
                            className="dark:text-slate-300 dark:hover:text-slate-400 flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out text-slate-900 hover:text-slate-400 lg:text-base"
