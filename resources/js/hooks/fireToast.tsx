...
//                     type="button"
//                     className="box-content mr-2 text-white border-none rounded-none opacity-100 hover:no-underline hover:opacity-50 focus:opacity-50 focus:shadow-none focus:outline-none"
