...
export default function Guest({ children }: PropsWithChildren) {
    return (
        <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
            <div className="hidden md:flex justify-center items-center bg-gradient-to-r from-blue-500 via-purple-500 to-pink-400">
            ...
            <div className="flex flex-col items-center min-h-screen px-10 pt-36 sm:justify-center sm:pt-0 sm:p-10 bg-gradient-to-l from-slate-600 via-slate-700 to-slate-800">
                <div className="w-full px-6 py-4 mt-6 overflow-hidden shadow-md sm:max-w-md bg-gray-800 sm:rounded-lg">
                    {children}
                </div>
            </div>
        </div>
